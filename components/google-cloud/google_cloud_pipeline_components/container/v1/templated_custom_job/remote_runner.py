...
def render_payload(payload_str: str, params: Dict[str, Any]) -> str:
  ...
  env = sandbox.ImmutableSandboxedEnvironment(autoescape=False)
...
def convert_key_value_param_list(
    param_list: List[List[str]], type_cast: Callable[[str], Any], cmd_flag: str
) -> Dict[str, Any]:
...
def convert_json_params(json_params: List[List[str]]) -> Dict[str, Any]:
